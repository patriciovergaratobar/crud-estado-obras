...
export class EditarEmpresaComponent implements OnInit {
  ...
  constructor(private empresaService: EmpresaServiceService, private dialog: MatDialog, private route: ActivatedRoute) { }
  ...
  loadDatos(empresaId) {
    ...
    this.empresaService.getById(empresaId).subscribe(res => {
      let empresa = res as Empresa;
      this.nombre = empresa.nombreEmpresa;
      this.rut = empresa.rutEmpresa;
  ...
  guardar() {
    ...
    this.empresaService.update(empresa as Empresa).subscribe((resp) => {
      ...
      if (resp['status'] == true) {
        ...
        let dialogOk = this.dialog.open(DialogoSimpleComponent,{
          data: {
            ...
            contenido: "La empresa fue actualizada exitosamente.",
